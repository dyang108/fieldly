...
class S3Storage(StorageInterface):
    ...
    def save_file(
        self, dataset_name: str, file_obj: BinaryIO, filename: str
    ) -> Dict[str, Any]:
        """
        Upload a file to S3
        ...
        try:
            ...
            if "CommonPrefixes" in response:
                for prefix in response["CommonPrefixes"]:
                    ...
                    if (
                        dataset_name.endswith("-md")
                        or dataset_name.endswith("-extracted")
                        or dataset_name.endswith("-extractedmd")
                        or dataset_name == "cached"
                    ):
                        continue
    ...
    def create_dataset(self, dataset_name: str) -> bool:
        ...
        try:
            ...
            self.s3_client.put_object(Bucket=self.bucket_name, Key=prefix, Body="")
